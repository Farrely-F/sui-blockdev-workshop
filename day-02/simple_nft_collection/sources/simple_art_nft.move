...
public fun activate_minting(collection: &mut Collection, admin_cap: &AdminCap, _ctx: &TxContext) {
...
public fun add_attribute(nft: &mut SimpleNFT, key: vector<u8>, value: vector<u8>, ctx: &TxContext) {
...
public fun get_dynamic_field<T: store>(nft: &SimpleNFT, key: vector<u8>): &T {
...
): (String, String, address, u64, u64, u64, bool, u64, u64) {
    (
        collection.name,
